...
import com.fantasticfive.test.shared.enums.Color;
import com.fantasticfive.test.shared.enums.UnitType;
import org.junit.*;
...
public class UnitTest extends SettingsTest {
    ...
    public void testMove() {
        ...
        assertFalse("New Point should be within movement range",result.equals(expected));
